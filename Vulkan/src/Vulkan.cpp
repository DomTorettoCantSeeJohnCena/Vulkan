...
const std::string vertexShaderPath = "Vulkan/shaders/vert.spv";
const std::string fragmentShaderPath = "Vulkan/shaders/frag.spv";

const std::string MODEL_PATH = "Vulkan/models/viking_room.obj";
const std::string TEXTURE_PATH = "Vulkan/textures/viking_room.png";
...
private:
    ...
    void initWindow()
    {
        ...
        VKPrint(glfwGetVersionString())
            ...
            GLFWimage images[2];
        images[0].pixels = stbi_load("Vulkan/Icon/Axe.png", &images[0].width, &images[0].height, 0, 4);
